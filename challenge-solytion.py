...
#2.3 [  This just prints out the value of the variable in the terminal.]

hello_fariha = "Hey, I just wanted to say hi to you. Would you like to learn some Python today."
print(hello_fariha)

# 2.4 [ This was ablout how you can combine two strings together.]
...
# 2.8 [ Good ol additional easy stuff]
...
# 2.9 [ What this is doing is showing how you need to convert the value of integer if you want to use it with other strings. You can do it using str() and it'll convert it.]
